...
public class SimpleExplosion extends Particles {
	...
	public SimpleExplosion(float x, float y) {
		super(numParticles, texture, x, x, y, y, minDx, maxDx, minDy, maxDy,
				...
				maxHeight, minLife, maxLife, doFade);
	}
	
	/*
	private static final int numParticles = 100;
	private static final String texture = "resources/images/ball.png";
	private static final float minDx = -30.0f;
	private static final float maxDx = 30.0f;
	private static final float minDy = -30.0f;
	private static final float maxDy = 30.0f;
	private static final float minAx = -3.0f;
	private static final float maxAx = 3.0f;
	private static final float minAy = -3.0f;
	private static final float maxAy = 3.0f;
	private static final float minWidth = 10.0f;
	private static final float maxWidth = 10.0f;
	private static final float minHeight = 10.0f;
