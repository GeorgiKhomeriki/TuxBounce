...
public class MenuState2 implements IGameState {
	...
	private enum SELECTION {
		START, OPTIONS, CREDITS, EXIT, RESOLUTION, OPTIONS_BACK
	}
	...
	public void renderOptions() {
		...
		highlightSelection(SELECTION.OPTIONS_BACK);
		font.drawText("BACK", Display.getWidth() / 2.0f,
				getSelectionY(SELECTION.OPTIONS_BACK));
	}
	...
	private void doMainSelectionAction() {
		if (Keyboard.isKeyDown(Keyboard.KEY_RETURN) || Mouse.isButtonDown(0)) {
			...
			case OPTIONS:
				...
				currentSelection = SELECTION.RESOLUTION;
				break;
			case CREDITS:
